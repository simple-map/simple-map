...
var Loader = require('map__loader').Loader;
...
var INIT_MAP_TIMEOUT = exports.INIT_MAP_TIMEOUT = 5000;
...
$.extend(Map.prototype, Observable, {
    ...
    _onLoadSuccess: function () {
        this._loader.destroy();
        this._view = new YandexMap($(this._model.get('container'))[0], {
